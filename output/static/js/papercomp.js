function isNumeric(num ) {
        ...
        vec.prototype._add =  function(p) {
            if (isNumeric(arguments[0])) {
                return vec(this.x + p, this.y + p, this.z + p);
            }
            else {
                var nx = this.x + p.x;
                var ny = this.y + p.y;
      ...
      vec.prototype._subtract =  function(p) {
            if (isNumeric(arguments[0])) {
                return vec(this.x - p, this.y - p, this.z - p);
            }
            else {
       ...
       vec.prototype._negate = function() {
             var nx = this.x * -1;
             var ny = this.y * -1;
             var nz = this.z * -1;
             return vec(nx, ny, nz); 
       ...
       vec.prototype._multiply =  function(p) {
            if (isNumeric(arguments[0])) {
                return vec(this.x * p, this.y * p, this.z * p);
            }
            else {
       ...
       vec.prototype._divide =  function(p) {
